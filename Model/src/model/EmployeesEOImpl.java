...
public class EmployeesEOImpl extends EntityImpl {
    ...
    public static final int JOBEO = AttributesEnum.JobEO.index();
     ...
     * @return the associated entity oracle.jbo.RowIterator.
     */
    public RowIterator getDepartmentsEO1() {
        return (RowIterator) getAttributeInternal(DEPARTMENTSEO1);
    }

    /**
     * @return the associated entity oracle.jbo.server.EntityImpl.
     */
    public EntityImpl getJobEO() {
        return (EntityImpl) getAttributeInternal(JOBEO);
    }

    /**
     * Sets <code>value</code> as the associated entity oracle.jbo.server.EntityImpl.
     */
    public void setJobEO(EntityImpl value) {
        setAttributeInternal(JOBEO, value);
    }
